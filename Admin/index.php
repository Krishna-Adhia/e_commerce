...
<head>
    ...
    <?php
        ...
        include_once 'con_totalusers.php';
        include_once 'con_totalproducts.php';
    ?>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $total_user;?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $total_products;?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php
                                include_once '../visits_conter.php'; 
                            ?>
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Website Visitors</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo $_SESSION['visit'];?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
